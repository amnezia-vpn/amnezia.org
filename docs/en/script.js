var linkWin =
  "https://github.com/amnezia-vpn/desktop-client/releases/download/1.5/AmneziaVPN_1.5.3.exe";
var linkMac =
  "https://github.com/amnezia-vpn/desktop-client/releases/download/1.5/AmneziaVPN_1.5.3.dmg";
...
if (document.getElementById("main") != null) {
  if (deviceWin) {
    document
      .getElementById("btn-personal")
      .setAttribute("src", "img/windows_fff.svg");
    document
      .getElementById("link-img-personal")
      .setAttribute("src", "img/mac.svg");
    document.getElementById("link-personal").innerHTML = "Download Mac version";
    document.getElementById("link-footer").innerHTML =
      "For Windows. Completely free.";
    ...
    document
      .getElementById("btn-personal")
      .setAttribute("src", "img/mac_fff.svg");
    document
      .getElementById("link-img-personal")
      .setAttribute("src", "img/windows.svg");
    document.getElementById("link-personal").innerHTML =
      "Download Windows version";
    document.getElementById("link-footer").innerHTML =
      "For Mac. Completely free.";
...
if (document.getElementById("instruction") != null) {
  ...
  document
    .getElementById("server-instr-step-1")
    .addEventListener("click", function () {
  ...
  document
    .getElementById("server-instr-step-2")
    .addEventListener("click", function () {
  ...
  document
    .getElementById("server-instr-step-3")
    .addEventListener("click", function () {
